...
# Información Financiera — tercer módulo/tarjeta propio en el selector de
# apps (junto a Consulta+Tablero y Seguimiento Convenios MC, no dentro de
# ninguno de los dos) — define su propio prefix completo ("/reportes-financieros").
app.include_router(reportes_financieros.router)
