...
class SuspensionTemporalBase(SQLModel):
    ...
    periodo_suspension_temporal: str = Field(max_length=6)
    motivo_suspension_temporal: str = Field(max_length=255)
    radicado_pqrs: Optional[str] = Field(default=None, max_length=30)


class SuspensionTemporal(SuspensionTemporalBase, table=True):
    __tablename__ = "suspension_temporal"
...
class SuspensionTemporalCreate(SuspensionTemporalBase):
    pass
